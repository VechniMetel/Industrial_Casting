StartupEvents.registry("item", (event) => {
    event.create("the_magical_industry:embers_charm")
        .unstackable()
        .tag("spell")
    event.create("the_magical_industry:royal_steel_charm")
        .unstackable()
        .tag("spell")
    event.create("the_magical_industry:cogito_ergo_sum")
        .unstackable()
        .tag("brain")
    event.create("the_magical_industry:embers_charm_plus")
        .unstackable()
        .tag("spell")
});
